...
export function buildMonitoringSourceProfile(
  ...
  const evidenceSnapshot = !isResponse && urgencyReceipt
    ? Object.freeze({
      ...
      evidenceQuality: urgencyReceipt.method === 'modeled' ? 'Modeled estimate' : 'Evidence-backed',
      reviewStatus: urgencyReceipt.scientific_review?.status === 'approved' ? 'Scientifically approved' : 'Review pending',
      uncertainty: urgencyReceipt.uncertainty || 'Uncertainty not reported.',
